<template>
  ...
  <div slot="modal-footer" v-if="type===TYPES.ALERT">
    <b-button class="float-right" :variant="okType" data-action="auto-focus" @click="toggle($event, 'ok')">
      {{ okBtnText }}
    </b-button>
  </div>
  <div slot="modal-footer" v-else>
    <b-button class="float-right" :variant="cancelType" @click="toggle($event, 'cancel')">
      {{ cancelBtnText }}
    </b-button>
    <b-button class="float-right" v-if="type===TYPES.CONFIRM" :variant="okType" data-action="auto-focus" @click="toggle($event, 'ok')">
      {{ okBtnText }}
    </b-button>
    <b-button class="float-right" v-else :variant="okType" @click="validate">
      {{ okBtnText }}
    </b-button>
  </div>
  </b-modal>
